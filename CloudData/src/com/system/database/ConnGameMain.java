...
public abstract class ConnGameMain
{
    ...
    public static DataSource setupDataSource()
    {
        ...
        ds.setUrl(ConfigManager.getConfigData("MainHtGameDbServer"));
        ds.setUsername(ConfigManager.getConfigData("MainHtGameUserName"));
        ds.setPassword(ConfigManager.getConfigData("MainHtGamePassword"));
        ds.setInitialSize(4);
        ds.setMaxActive(32);
        ds.setMaxIdle(8);
        ds.setMinIdle(4);
