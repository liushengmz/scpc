...
<%
	...
	int groupId = StringUtil.getInteger(ConfigManager.getConfigData("GAME_CP_CPS_GROUP_ID"),-1);
	
	AppModel app = new AppServer().loadAppById(id);
		...
		<div class="content" style="margin-top: 10px">
			<dl>
				<dd class="ddbtn" style="width:500px">
					<label>游戏CP登录分配(<%= app.getAppname() %>)</label>
				</dd>
			</dl>
			<br /> <br />
			<dl>
