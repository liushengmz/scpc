...
<%
	...
	int flag=new SpServer().checkAdd(userId);
	int pageIndex = StringUtil.getInteger(request.getParameter("pageindex"), 1);
	String keyWord = StringUtil.getString(request.getParameter("keyword"), "");

	Map<String, Object> map =  new SpServer().loadSp(pageIndex, keyWord,userId);
...
<body>
	<div class="main_content">
		<div class="content" >
			<dl>
				<dd class="ddbtn" ><a href="spadd.jsp" onclick="return checkAdd()">增  加</a></dd>
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="spedit.jsp?query=<%= query %>&id=<%= model.getId() %>" onclick="return checkUser('<%=model.getCommerceUserId()%>')">修改</a>
					</td>
				</tr>
				<%
					}
