...
<%
	...
	CpPushUrlModel model = new CpPushUrlServer().loadCpPushUrlModelById(id);
	
	if(model==null)
	{
		response.sendRedirect("cppushurl.jsp");
		return;
	}
	...
	<div class="main_content">
		<div class="content" style="margin-top: 10px;">
			<dl>
				...
				<label>CP同步 URL修改</label>
				</dd>
			</dl>
			<br />	<br />		
			<dl>
				<form action="cpurlaction.jsp?query=<%= StringUtil.getString(request.getParameter("query"), "") %>" method="post" id="addform">
