			...
			<table cellpadding="0" cellspacing="0" style="margin-top: 15px;">
				...
				<%
					...
					<tr>
						...
						<td><%= StringUtil.getDecimalFormat((Float)model.get("rate")) %></td>
						<td><%= StringUtil.getDecimalFormat((Float)model.get("dataAmount")) %></td>
						<td><%= StringUtil.getDecimalFormat((Float)model.get("rateDataAmount")) %></td>
					</tr>	
						<%
					}
				%>
