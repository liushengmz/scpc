...
<script type="text/javascript">
	...
	function fillProRatioCheckValue()
	{
		...
		for(var i=0; i<proArray.length; i++)
		{
			...
			value += "0" + "|" + proArray[i] + "|" + ratio + "|" + checked + ","
		}
		...
		<div class="content" style="margin-top: 10px">
			...
			<dl>
				<form action="action.jsp" method="post" id="addform">
					...
					<input type="hidden" name="type" id="hid_type" value="1" alt="增加">
					<dd class="dd01_me">供应商名称</dd>
					<dd class="dd03_me">
						<input  type="text" id="sel_sp_name" onclick="namePicker(this,spList,onSpDataSelect)" style="width: 200px;" readonly="readonly" >
						<input  type="hidden" id="sel_sp_id" name="sp_id">
					</dd>
					...
					<dd class="dd04_me">
						<select name="sp_api_id" id="sel_sp_api_id" 
							style="width: 200px">
					...
					<dd class="dd04_me">
						<select name="base_price_id" id="sel_base_price_id" onchange="changeSpTroneName()"
							style="width: 200px">
					...
					<dd class="dd03_me">
						<input type="text" name="sp_trone_name" title="业务名称" id="input_sp_trone_name" 
							style="width: 180px">
					</dd>
					...
					<dd class="dd03_me" style="background:url(../fdsws/member_input.gif) top right">
						<input type="text" name="ratio"  id="input_ratio" style="width: 100px" onchange="autoResetData(this.id,this.value)">
					...
					<div style="margin-left: 95px; width: 600px;text-align: center;" id="pro">
						<table >
							<%
								...
								{
									ProvinceModel proModel = provinceList.get(i);
									...
									out.print("<td id='pro_td_" + proModel.getId() + "'  style='border:1px solid #d2d2d2;cursor: pointer;'  onclick='reverseCheckPro(" + proModel.getId() + ")'><div style='text-align:center;'>");
									out.print(proModel.getName());
									out.print("<input type='text'  onchange=autoResetData(this.id,this.value)  id='pro_ratio_" + proModel.getId() + "' style='width:40px;background-color:#E3E3E3;text-align:center;margin-left:10px;' value='1000' />");
									out.print("<input type='checkbox' id='pro_check_" + proModel.getId() + "' name='pro_check' title='" + proModel.getName() + "' style='margin-left:15px;' onclick='reverseCheckPro(" + proModel.getId() + ")' />");
									out.print("</div></td>");
								}
								out.print("</tr>");
							%>
