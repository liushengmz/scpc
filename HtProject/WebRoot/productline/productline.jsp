...
<%
	...
	Map<String, Object> map =  new ProductServer().loadLineProduct(pageIndex, keyWord);
	...
	String pageData = PageUtil.initPageQuery("productline.jsp",params,rowCount,pageIndex);
...
<body>
	<div class="main_content">
		<div class="content" >
			<dl>
				<dd class="ddbtn" ><a href="productlineadd.jsp">增  加</a></dd>
				<form action="productline.jsp"  method="get" id="formid">
				<dl>
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="productlineedit.jsp?query=<%= query %>&id=<%= model.getProductLineId() %>">修改</a>
						<a href="action.jsp?type=3&id=<%= model.getProductLineId() %>" onclick="if(confirm('确定删除?')==false)return false">删除</a>
					</td>
				</tr>
				<%
					}
