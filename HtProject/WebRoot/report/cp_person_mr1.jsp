...
<%
	...
	System.out.println("userRightList:" + userRightList);
	...
	params.setCpCommerceUserId(userRightList);
	params.setIsUnHoldData(-1);
	params.setJsType(-1);
...
<body>
	<div class="main_content">
		<div class="content">
			<form action="cp_person_mr1.jsp" method="get" style="margin-top: 10px">
