...
<%
	...
	Map<String, Object> map =  new MrServer().getMrTodayDataQiBa(spId, spTroneId,troneId, cpId, troneOrderId, provinceId, cityId, sortType);
...
<body>
	<div class="main_content">
		<div class="content" >
			<form action="mr4.jsp"  method="get">
				<dl>
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tbody>		
				<%
					...
					{
						title = StringUtil.getString(model.getTitle1(), "");
						%>
				<tr>
					<td><%= index++ %></td>
					<td><%= PinYinUtil.getPinYinHeadChar(title) %></td>
