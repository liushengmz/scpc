...
<%
	...
	Map<String, Object> map = new MrServer().getWjMrAnalyData(params);
...
<body>
	<div class="main_content">
		<div class="content">
			<form action="wjmr.jsp" method="get" style="margin-top: 10px">
				<dl>
