...
<%
	...
	Map<String, Object> map =new SdkSpServer().loadSdkSp(pageIndex, keyWord);
		
	List<SdkSpModel> list = (List<SdkSpModel>)map.get("list");
	...
	String pageData = PageUtil.initPageQuery("sdksp.jsp",params,rowCount,pageIndex);
...
<body>
	<div class="main_content">
		<div class="content" >
			<dl>
				<dd class="ddbtn" ><a href="sdkspadd.jsp">增  加</a></dd>
				<form action="sdksp.jsp"  method="get" id="formid">
				<dl>
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<a href="sdkspedit.jsp?query=<%= query %>&id=<%= model.getId() %>">修改</a>
