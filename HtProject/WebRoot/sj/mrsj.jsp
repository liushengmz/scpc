...
<%@page import="com.system.server.MrSjServer"%>
...
<%
	...
	String[] titles = {"日期","周数","月份","SP","CP","通道","CP通道","省份","城市","SP业务","时间","SP商务","CP商务","运营商","数据类型","第一业务线","第二业务线"};
...
<body>
	<div class="main_content">
		<div class="content" >
			<form action="mrsj.jsp"  method="get" style="margin-top: 10px">
				<dl>
