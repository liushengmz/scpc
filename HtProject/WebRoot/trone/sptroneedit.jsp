...
<script type="text/javascript">
	...
	function resetFormTwo()
	{
		...
		$("#alarm_start_hour").val("<%=spTroneModel.getAlarmStartHour()%>");
		$("#alarm_end_hour").val("<%=spTroneModel.getAlarmEndHour()%>");
...
<%=spTroneModel.getStatus()%>
		...
		setRadioCheck("is_watch_data",<%= spTroneModel.getIsWatchData() %>);
		...
		<div class="content" style="margin-top: 10px">
			...
			<dl>
				<form action="sptroneaction.jsp?query=<%=query%>" method="post"
					...
					<dd class="dd04_me">&nbsp;&nbsp;&nbsp;&nbsp;开始时间
						<select name="alarm_start_hour" id="alarm_start_hour" style="width:50px"  >
						...
						&nbsp;&nbsp;&nbsp;&nbsp;结束时间
						<select name="alarm_end_hour" id="alarm_end_hour"  style="width:50px" >
							<option value=0>0</option>
							<option value=1>1</option>
							<option value=2>2</option>
							<option value=3>3</option>
