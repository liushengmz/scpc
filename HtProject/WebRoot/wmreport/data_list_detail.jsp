...
<%
	...
	List<WmDataModel> list = new WmDataServer().loadWmDataDetail(troneOrderId, startDate, endDate);
%>
		...
		<table cellpadding="0" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					...
					<td><%= model.getSpPrice() %></td>
					<td><%= model.getSpDataRows()%></td>
					<td><%= StringUtil.getDecimalFormat(model.getSpDataAmount())  %></td>
