...
public class Menu2Dao
{
	...
	public List<Menu2Model> loadMenu2List()
	{
		String sql = "select a.id menu2Id,a.name menu2Name,b.id menu1Id,b.name menu1Name,"
				+ "c.id menuHeadId,c.name menuHeadName,a.url,a.action_url,a.remark from " + Constant.DB_DAILY_CONFIG + ".tbl_menu_2 a left join " + Constant.DB_DAILY_CONFIG + ".tbl_menu_1 b "
				+ "on a.menu_1_id = b.id left join " + Constant.DB_DAILY_CONFIG + ".tbl_menu_head c on b.head_id = c.id "
