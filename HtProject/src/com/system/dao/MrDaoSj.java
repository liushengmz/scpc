...
//		<option value="5">指令</option>
	...
	{
		String sql = "UPDATE daily_log.`tbl_mr_summer_2` a," + com.system.constant.Constant.DB_DAILY_CONFIG + ".`tbl_trone` b," + com.system.constant.Constant.DB_DAILY_CONFIG + ".`tbl_sp_trone` c ";
	...
	{
		String sql = " UPDATE daily_log.`tbl_cp_mr_summer_2` a," + com.system.constant.Constant.DB_DAILY_CONFIG + ".`tbl_trone` b,";
