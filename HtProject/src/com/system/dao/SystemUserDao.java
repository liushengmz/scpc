...
public class SystemUserDao {
	...
	{
		String sql = "select " + Constant.CONSTANT_REPLACE_STRING + " FROM  " + com.system.constant.Constant.DB_DAILY_CONFIG + ".`tbl_group_user` a LEFT JOIN  " + com.system.constant.Constant.DB_DAILY_CONFIG + ".tbl_user b ON a.`user_id` = b.`id` where a.create_user="+userId;
		
		String query = "";
		
		String sql2 = "select " + Constant.CONSTANT_REPLACE_STRING + " FROM " + com.system.constant.Constant.DB_DAILY_CONFIG + ".tbl_user a LEFT JOIN " + com.system.constant.Constant.DB_DAILY_CONFIG + ".`tbl_user` b ON b.`id`=a.`create_user` where a.create_user="+userId;
	...
	public boolean adduser(SystemUserModel model){
		String sql = "INSERT INTO `" + com.system.constant.Constant.DB_DAILY_CONFIG + "`.`tbl_user`(`name`,`pwd`,`mail`,`qq`,`phone`,`create_user`,`status`) "
