...
public abstract class ConnLvMain
{
    ...
    public static DataSource setupDataSource()
    {
        ...
        ds.setUrl(ConfigManager.getConfigData("MainLvServer"));
        ds.setUsername(ConfigManager.getConfigData("MainLvUserName"));
        ds.setPassword(ConfigManager.getConfigData("MainLvPassword"));
        ds.setInitialSize(4);
        ds.setMaxActive(32);
        ds.setMaxIdle(8);
        ds.setMinIdle(4);
