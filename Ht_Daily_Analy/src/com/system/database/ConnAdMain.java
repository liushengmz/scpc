...
public abstract class ConnAdMain
{
    ...
    public static DataSource setupDataSource()
    {
        ...
        ds.setUrl(ConfigManager.getConfigData("MainAdDbServer"));
        ds.setUsername(ConfigManager.getConfigData("MainAdUserName"));
        ds.setPassword(ConfigManager.getConfigData("MainAdPassword"));
        ds.setInitialSize(4);
        ds.setMaxActive(32);
        ds.setMaxIdle(8);
        ds.setMinIdle(4);
