...
package com.pay.business.util.wftpay.weChatSubscrPay.utils;
...
* @Package com.pay.business.util.weChatSubscrPay.utils 
* @Description: 签名用的工具箱:此类为威富通商家提供；不作全局使用
* @author 周立波     
* @date 2017年6月27日 下午5:35:20 
* @version V1.0
*/
