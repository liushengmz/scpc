...
public class Payv2BussSupportPayWayController extends BaseManagerController<Payv2BussCompany, Payv2BussCompanyMapper>{
	...
	*/
    ...
    public ModelAndView getSupportPayWayList(@RequestParam Map<String, Object> map) {
        ModelAndView mv = new ModelAndView("payv2/supportPayWay/payv2BussSupportPayWay-list");
    ...
    */
    ...
    public ModelAndView addPayWayStatusTc(@RequestParam Map<String,Object> map){
    	 ModelAndView mv = new ModelAndView("payv2/supportPayWay/payv2BussSupportPayWay-add");
     ...
     */
     ...
     public ModelAndView getAppSupportPayWay(@RequestParam Map<String,Object> map){
    	 ModelAndView mv = new ModelAndView("payv2/supportPayWay/Payv2BussAppSupportPayWay-list");
     ...
     */
     ...
     public ModelAndView addAppSupportPayWayTc(@RequestParam Map<String,Object> map){
    	 ModelAndView mv = new ModelAndView("payv2/supportPayWay/Payv2BussAppSupportPayWay-add");
    	 //获取商户支付通道列表
