...
import com.lulu.player.utils.PixFormat;

/**
 * @author zxc
 * @time 2016/10/26 0026下午 4:28
 */
public class ToastHelper {
    ...
    private void init() {
        ...
        mWindowParams.y = PixFormat.formatDipToPx(c, 80);
    }
    ...
    public void show() {
        ...
        if (toastView == null) {
            ...
            TextView toast = (TextView) toastView.findViewById(R.id.toast);
            toast.setText(mToastContent);

        }
        mWindowParams.gravity = android.support.v4.view.GravityCompat
                .getAbsoluteGravity(Gravity.TOP,
