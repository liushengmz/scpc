...
<%
	...
	MenuHeadModel model = new MenuHeadServer().loadMenuById(id);
	List<String> list = new MenuHeadServer().loadMenuName(id);
		...
		<div class="content" style="margin-top: 10px">
			...
			<dl>
				...
				<input type="hidden" value="<%= model.getId() %>" name="id" />
					...
					<dd class="dd03_me">
						<input type="text" name="menu_name" id="input_menu_name" value="<%=model.getName() %>"
							style="width: 200px">
					</dd>
					...
					<dd class="dd03_me">
						<input type="text" name="remark" id="input_remark" value="<%=model.getRemark() %>"
							style="width: 200px">
					</dd>
					...
					<dd class="dd03_me">
						<input type="text" name="sort" id="input_sort" value="<%=model.getSort() %>"
							style="width: 200px">
					</dd>
