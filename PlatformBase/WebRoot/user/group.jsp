...
<%
	...
	String pageData = PageUtil.initPageQuery("group.jsp",null,rowCount,pageIndex);
...
<body>
	<div class="main_content">
		<div class="content" >
			<dl>
				<dd class="ddbtn" ><a href="groupadd.jsp">增  加</a></dd>
				<form action="group.jsp"  method="post" id="formid">
				<dl>
