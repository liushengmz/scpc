...
//		 Map<String,Integer> map = dao.loadPhoneLocateMap();
//		 List<PhoneLocateModel> list = dao.loadPhoneLaceteList();
//		 LocateCache.setPhoneLocate(map);
//		 LocateCache.setPhoneLocateList(list);
		
		LocateCache.setPhoneLocateList(dao.loadPhoneOperatorLaceteMap());
