...
public class CpDataDao
{
	...
	{
		String sql = "select * from " + com.sytem.dd.DddFord.dataBase + ".tbl_cp order by convert(short_name using gbk) asc";
	...
	{
		String sql = "SELECT * FROM " + com.sytem.dd.DddFord.dataBase + ".`tbl_cp_trone_rate`";
	...
	{
		String sql  = "select a.*,b.short_name,c.sp_id,c.trone_name,c.price,c.sp_trone_id from " + com.sytem.dd.DddFord.dataBase + ".tbl_trone_order a "
				+ " left join " + com.sytem.dd.DddFord.dataBase + ".tbl_cp b on a.cp_id = b.id "
				+ " left join " + com.sytem.dd.DddFord.dataBase + ".tbl_trone c on a.trone_id = c.id "
				+ " LEFT JOIN " + com.sytem.dd.DddFord.dataBase + ".`tbl_sp_trone` d ON c.`sp_trone_id` = d.`id`"
