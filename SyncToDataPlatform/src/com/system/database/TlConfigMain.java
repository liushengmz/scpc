...
public abstract class TlConfigMain
{
    ...
    public static DataSource setupDataSource()
    {
        ...
        ds.setUrl(ConfigManager.getConfigData("TlDbServer"));
        ds.setUsername(ConfigManager.getConfigData("TlDbServerName"));
        ds.setPassword(ConfigManager.getConfigData("TlDbServerPwd"));
        ds.setInitialSize(4);
        ds.setMaxActive(32);
        ds.setMaxIdle(8);
        ds.setMinIdle(4);
