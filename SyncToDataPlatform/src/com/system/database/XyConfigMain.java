...
public abstract class XyConfigMain
{
    ...
    public static DataSource setupDataSource()
    {
        ...
        ds.setUrl(ConfigManager.getConfigData("XyDbServer"));
        ds.setUsername(ConfigManager.getConfigData("XyDbServerName"));
        ds.setPassword(ConfigManager.getConfigData("XyDbServerPwd"));
        ds.setInitialSize(4);
        ds.setMaxActive(32);
        ds.setMaxIdle(8);
        ds.setMinIdle(4);
