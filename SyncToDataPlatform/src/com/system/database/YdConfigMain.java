...
public abstract class YdConfigMain
{
    ...
    public static DataSource setupDataSource()
    {
        ...
        ds.setUrl(ConfigManager.getConfigData("YdDbServer"));
        ds.setUsername(ConfigManager.getConfigData("YdDbServerName"));
        ds.setPassword(ConfigManager.getConfigData("YdDbServerPwd"));
        ds.setInitialSize(4);
        ds.setMaxActive(32);
        ds.setMaxIdle(8);
        ds.setMinIdle(4);
