...
public abstract class ConnConfigMain
{
    ...
    public static DataSource setupDataSource()
    {
        ...
        ds.setUrl(PropertyConfigUtil.getConfigData("MainConfigDbServer"));
        ds.setUsername(PropertyConfigUtil.getConfigData("MainConfigUserName"));
        ds.setPassword(PropertyConfigUtil.getConfigData("MainConfigPassword"));
        ds.setInitialSize(4);
        ds.setMaxActive(32);
        ds.setMaxIdle(8);
        ds.setMinIdle(4);
