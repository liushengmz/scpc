...
public class PropertyConfigUtil
{
	...
	private static void init()
	{
		...
		try
		{
			...
			{
				 ClassLoader loader = PropertyConfigUtil.class.getClassLoader();
	...
	{
		URL url = PropertyConfigUtil.class.getProtectionDomain().getCodeSource()
				.getLocation();
	...
	public static void setConfigFilePath(String configFilePath)
	{
		...
		System.out.println("config file path suc : " + isExistFile);
	...
	{
		setConfigFilePath("");
		System.out.println("data:" + getProperty("DF_CO_NAME"));
