 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class Report1042 {
	private static Logger logger = Logger.getLogger(Report.class);

	private String sql="";
	private String leagueid="1042";

	public Report1042(Statement db)
	{
		logger.debug("now begin Report1042===X-…Ó€⁄∞¡π‚");
		checkReport(db);
		...
		String updatesql="";
			...
			if (!updatesql.equals("")) {
				try {
					...
					String res=send("http://119.147.24.103:8080/channel/cshd2",sb);
					//http://119.147.24.103:8080/channel/cshd2
					logger.debug("1042Report res:"+res);
					if (res.equals("0")) {
