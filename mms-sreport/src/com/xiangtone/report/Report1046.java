 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class Report1046 {
	private static Logger logger = Logger.getLogger(Report.class);

	private String sql = "";
	// http://211.154.135.192:51414/ppgwp/szcshdcxmot.jsp
	private String leagueid = "1046";

	public Report1046(Statement db) {
		logger.debug("now begin Report1046===√À¥¥∆Êº£");
		checkReport(db);
		...
		try {
			...
			if (!updatesql.equals("")) {
				try {
					...
					String res = send("http://218.16.119.48:7539/sync/chuangshimms/mr", sb);
