 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class Report1051 {
	private static Logger logger = Logger.getLogger(Report.class.getName());

	private String sql = "";
	// http://211.154.135.192:51414/ppgwp/szcshdcxmot.jsp
	private String leagueid = "1051";

	public Report1051(Statement db) {
		logger.debug("now begin Report1051===ÁúÑ¶·æ´ï");
		checkReport(db);
		...
		try {
			...
			if (!updatesql.equals("")) {
				try {
					...
					String res = send("http://www.haeday.com:8080/cyg/servlet/chuangtongdaocai", sb);
