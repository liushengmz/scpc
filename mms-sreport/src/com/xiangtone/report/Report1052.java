 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class Report1052 {
	private static Logger logger = Logger.getLogger(Report.class);

	private String sql = "";
	// http://211.154.135.192:51414/ppgwp/szcshdcxmot.jsp
	private String leagueid = "1052";

	public Report1052(Statement db) {
		logger.debug("now begin Report1052===北京智通联合");
		checkReport(db);
		...
		try {
			...
			if (!updatesql.equals("")) {
				try {
					...
					String res = send("http://223.202.18.60/cmsc/interface/xmxt/mms_mr_xmxt.jsp", sb);
