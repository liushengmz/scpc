 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class Report1054 {
	private static Logger logger = Logger.getLogger(Report.class);

	private String sql = "";
	// http://211.154.135.192:51414/ppgwp/szcshdcxmot.jsp
	private String leagueid = "1054";

	public Report1054(Statement db) {
		logger.debug("now begin Report1054===真石信息");
		checkReport(db);
		...
		try {
			...
			if (!updatesql.equals("")) {
				try {
					...
					String res = send("http://222.73.127.57:8010/sp/mr.xml?i=xt", sb);
					// http://119.147.24.103:8080/channel/cshd2
					logger.debug("1054Report res:" + res);
					if (res.equals("0")) {
