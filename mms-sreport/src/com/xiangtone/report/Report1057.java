 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class Report1057 {
	private static Logger logger = Logger.getLogger(Report.class);

	private String sql = "";
	// http://211.154.135.192:51414/ppgwp/szcshdcxmot.jsp
	private String leagueid = "1057";
	private String leagueName = "X-…œ∫£∆∑ø·";
	private String leagueUrl = "http://ibingo.net.cn/fee/cshdmmsmrse";

	public Report1057(Statement db) {
		logger.debug("now begin Report1056===" + leagueName);
		checkReport(db);
