 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class Report1059 {
	private static Logger logger = Logger.getLogger(Report.class);

	private String sql = "";
	// http://211.154.135.192:51414/ppgwp/szcshdcxmot.jsp
	private String leagueid = "1059";
	private String leagueName = "示共利大";
	private String leagueUrl = "http://120.72.43.40:8080/interface/rptrecvtltd";

	public Report1059(Statement db) {
