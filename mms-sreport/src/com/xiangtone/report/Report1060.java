 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class Report1060 {
	private static Logger logger = Logger.getLogger(Report.class);

	private String sql = "";
	// http://211.154.135.192:51414/ppgwp/szcshdcxmot.jsp
	private String leagueid = "1060";
	private String leagueName = "ÕÆÖÐºÆÔÄ";
	private String leagueUrl = "http://data.z3.cn:18803/xtMmsRpt.aspx";

	public Report1060(Statement db) {
