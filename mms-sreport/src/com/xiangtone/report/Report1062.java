 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class Report1062 {
	private static Logger logger = Logger.getLogger(Report.class);

	private String sql = "";
	// http://211.154.135.192:51414/ppgwp/szcshdcxmot.jsp
	private String leagueid = "1062";
	private String leagueName = "×¿ÒâÍòÁª";
	private String leagueUrl = "http://202.103.190.102:6000/sms/spxtMr.do";

	public Report1062(Statement db) {
