 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class Report1063 {
	private static Logger logger = Logger.getLogger(Report.class);

	private String sql = "";
	// http://211.154.135.192:51414/ppgwp/szcshdcxmot.jsp
	private String leagueid = "1063";
	private String leagueName = "X-×¿Ò×âý´ï";
	private String leagueUrl = "http://feesms.morefuntek.com:12550/MServer/cshdmmsReport.do";

	public Report1063(Statement db) {
