 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class Report1064 {
	private static Logger logger = Logger.getLogger(Report.class);

	private String sql = "";
	// http://211.154.135.192:51414/ppgwp/szcshdcxmot.jsp
	private String leagueid = "1064";
	private String leagueName = "√Ø±Ã–≈œ¢";
	private String leagueUrl = "http://gw.imichat.com:9001/xtmms/mr";

	public Report1064(Statement db) {
