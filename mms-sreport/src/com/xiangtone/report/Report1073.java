...
public class Report1073 {
	...
	private String leagueid = "1073";
	private String leagueName = "X-Éî¿Ú´ü";
	private String leagueUrl = "http://www.juhehd.com/phones/xiangtong.php";

	public Report1073(Statement db) {
	...
	private void checkReport(Statement db) {
		...
		try {
			...
			while (rs.next()) {
				...
				String exchangeTime = rs.getString("exchange_time");
				String successTime = rs.getString("success_time");
