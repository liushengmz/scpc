...
namespace LightDataModel
{
    ...
    /// tbl_mr_daily数据模型
    /// </summary>
    public partial class tbl_mr_dailyItem : Shotgun.Model.Logical.LightDataModel
    {
        /// <summary>
        /// 数据表字段列表对像
        /// </summary>
        ...
        public static readonly string tableName = "tbl_mr_daily";
...
,"api_order_id"
        ...
        /// 创建一个新的查询器
        /// </summary>
        public static Shotgun.Model.List.LightDataQueries<tbl_mr_dailyItem> GetQueries(Shotgun.Database.IBaseDataClass2 dBase)
        {
            return new Shotgun.Model.List.LightDataQueries<tbl_mr_dailyItem>(tableName, identifyField, dBase);
        }

        /// <summary>
        /// 创建一个新的查询器
        /// </summary>
        public static Shotgun.Model.List.LightDataQueries<tbl_mr_dailyItem> GetQueries()
        {
            return new Shotgun.Model.List.LightDataQueries<tbl_mr_dailyItem>(tableName, identifyField);
        }
        /// <summary>
        /// 根据主键查找指定的行,返回指定字段
        /// </summary>
        ...
        /// <returns></returns>
        public static tbl_mr_dailyItem GetRowById(Shotgun.Database.IBaseDataClass2 dBase, int id, string[] fields)
        {
        ...
        /// <param name="id">主键值</param>
        /// <returns></returns>
        public static tbl_mr_dailyItem GetRowById(Shotgun.Database.IBaseDataClass2 dBase, int id)
        {
